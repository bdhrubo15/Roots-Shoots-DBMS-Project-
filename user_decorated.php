...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/semantic.min.css">
  <title>Display Decorated Demo Data</title>
</head>
<body>
<style>
body {
...
<h2 style="padding-top: 50px"; align="center">Decorated Information</h2>

<table height=300px weidth=200px align="center" border="2">
  <tr>
    <td>Decorated Name</td>
    <td>Cost</td>
    <td>Left</td>
    <td>Rating</td>
    <td>Picture</td>
...
$records = mysqli_query($conn,"select * from plant where plant_code='deco'  "); 
...
?>
  <tr>
    ...
    <td><a href="user_decorated_edit.php?serial_port=<?php echo $data['serial_port']; ?>
...
<a href="user_fertilizer.php"><button style='margin: 0px 1000px' class='ui inverted green button'>Next</button></a><br><br>
