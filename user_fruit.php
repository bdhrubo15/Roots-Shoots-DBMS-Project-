...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/semantic.min.css">
  <title>Display Fruit Demo Data</title>
</head>
<body>
<style>
body {
...
<h2 style="padding-top: 80px"; align="center">Fruit Information</h2>
...
$records = mysqli_query($conn,"select * from plant where plant_code='fru'  "); 
...
?>
  <tr>
    ...
    <td><a href="user_fruit_edit.php?serial_port=<?php echo $data['serial_port']; ?>
...
<a href="user_wood.php"><button style='margin: 0px 1000px' class='ui inverted green button'>Next</button></a><br><br>
