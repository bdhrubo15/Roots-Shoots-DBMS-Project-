...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/semantic.min.css">
  <title>Display Wood Demo Data</title>
</head>
<body>
<style>
body {
...
<h2 style="padding-top: 80px"; align="center">Wood Information</h2>
...
$records = mysqli_query($conn,"select * from plant where plant_code='wood'  "); 
...
?>
  <tr>
    ...
    <td><a href="user_wood_edit.php?serial_port=<?php echo $data['serial_port']; ?>
...
<a href="user_decorated.php"><button style='margin: 0px 1000px' class='ui inverted green button'>Next</button></a><br><br>
