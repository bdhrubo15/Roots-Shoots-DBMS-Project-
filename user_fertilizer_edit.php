...
$fertilizer_code = $_GET['fertilizer_code']; 
$price = $_GET['cost'];
...
$query = "INSERT into online_delivery(order_status,user_email,employee_email,fertilizer_code) 
values('processing','$user','harrypoter@gmail.com','$fertilizer_code')";

$result = mysqli_query($conn,$query);
if($result){
header("Location:user_fertilizer_edit1.php");
die;
}
}
else
