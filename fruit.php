...
$sql ="SELECT * FROM plant where plant_code='fru'";
...
<body>
<h2 style="padding-top: 100px"; align='center'>Fruit Information
...
<a href="wood.php"><button style='margin: 0px 1000px' class='ui inverted green button'>Next</button></a><br><br>
